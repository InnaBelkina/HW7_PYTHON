...
# в фразах. Эта информация возвращается в виде списка словарей. Каждый элемент списка(словарь) соответствует фразе.
...
def Pooh (text):
    # cons = ['й',"ц","к","н","г","ш","щ","з","х","ъ","ж","д", "л","р","п","в","ф","б","ь","т","м","с","ч","-"]
...
print(Pooh("пара-ра-рам рам-пам-папам па-ра-па-дам"))
print(Pooh("пара-ра-рам рам-пум-пупам па-ре-по-дам"))
print(Pooh("пара-ра-рам рам-пуум-пупам па-ре-по-дам"))
print(Pooh("Трам-пара-папам-парам-па-пам-пам-па Пум-пурум-пу-пурум-трам-пам-па"))
print(Pooh("Пам-парам-пурум Пум-пурум-карам"))
